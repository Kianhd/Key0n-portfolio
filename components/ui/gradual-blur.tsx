...
// Removed mathjs import - using native JavaScript math functions
...
const mergeConfigs = (...configs: Array<Partial<GradualBlurConfig>>): GradualBlurConfig => 
...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      let v = config[key];
      const capitalizedKey = (key[0].toUpperCase() + key.slice(1)) as 'Height' | 'Width';
